...
--> Binding 48 | FilterToConsumerType: ActiveScriptEventConsumer | EventFilterName: fuckyoumm2_filter | EventConsumerName: fuckyoumm2_consumer

### And then present the contents of the EventConsumers and EventFilters

--> EventFilter: select * from timerevent where timerid="fuckyoumm2_itimer"
